...
- Runs on k3d, arm64; Terraform (tofu) modules; Python controller (kopf).
...
- Anything outside `k8s-just-in-time-infra/`; the voting app lives in `app/` and is edited there.
